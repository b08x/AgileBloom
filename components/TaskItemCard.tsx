...
import { TrackedTask, TaskStatus } from '../types';
import { EXPERTS, ID_PREFIX_LENGTH_TASKS } from '../constants';
import { Circle, Settings2, Check, Trash2, User } from 'lucide-react';
...
export const TaskItemCard: React.FC<TaskItemCardProps> = ({ task, onUpdateStatus, onRemove, isDisabled }) => {
